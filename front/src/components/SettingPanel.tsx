      ...
      <AnimatePresence>
        {isSettingsOpen && (
          <motion.div
            ...
            className="absolute right-0 top-0 w-[350px] bg-[#1a1c1e]/95 backdrop-blur-xl border border-white/10 rounded-[2rem] p-7 shadow-[0_20px_50px_rgba(0,0,0,0.5)] z-[100] origin-top-right"
          >
            {/* 헤더 */}
